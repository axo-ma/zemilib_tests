...
class BamlAsyncClient:
    ...
    async def Hello(self, message: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.Hello(message=message,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="Hello", args={
                "message": message,
            })
...
class BamlStreamClient:
    ...
    def Hello(self, message: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="Hello", args={
            "message": message,
        })
...
class BamlHttpRequestClient:
    ...
    async def Hello(self, message: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="Hello", args={
            "message": message,
        }, mode="request")
        return __result__
